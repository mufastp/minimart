...
class CartItem {
  ...
  final double originalPrice; // Store the original price
  double price; // Make this editable
  double? discount;
  int quantity;
  int unitId;
  double tax_percentage;
  TextEditingController discountController;
  TextEditingController priceController; // Add controller for price editing
  ...
  CartItem({
    ...
    required this.rateChangeAllowed, // Add this
  }) : discountController = TextEditingController(text: discount!.toStringAsFixed(1)),
        priceController = TextEditingController(text: price.toStringAsFixed(2)); // Initialize price controller
